    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.themeRow}>
        ...
        <View style={styles.searchEngineOptions}>
          {(['duckduckgo', 'google', 'brave', 'startpage'] as const).map(engine => (
            <TouchableOpacity
              key={engine}
              style={[styles.searchEngineChip, settings.searchEngine === engine && styles.searchEngineChipActive]}
              onPress={() => {
                haptics.light();
...
const makeStyles = (theme: ReturnType<typeof useTheme>) =>
  StyleSheet.create({
    ...
    searchEngineOptions: {flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 12},
    searchEngineChip: {
    ...
    searchEngineChipActive: {backgroundColor: theme.primary, borderColor: theme.primary},
    searchEngineChipText: {color: theme.textMuted, fontSize: 12, fontWeight: '600', textTransform: 'capitalize'},
    searchEngineChipTextActive: {color: theme.onPrimary},
  });
